...
const config = {
  ...
  organizationName: 'ensavvy', // Usually your GitHub org/user name.
  projectName: 'ensavvy.github.io', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Ensavvy Inc.`,
      },
      prism: {
